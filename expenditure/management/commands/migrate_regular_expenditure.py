...
from expenditure.models import RegularExpenditure


class Command(BaseCommand):
    help = 'Migrate regular expenditure data with duplicate phone number handling'
    ...
    def load_mappings(self):
        ...
        employee_pk_mapping_file_path = os.path.join(os.path.dirname(__file__), 'employee_log_file_regular.csv')
    ...
    def handle(self, *args, **options):
        ...
        json_file_path = os.path.join(os.path.dirname(__file__), 'expenditure_regular.json')
        log_file_path = os.path.join(os.path.dirname(__file__), 'expenditure_regular_log_file.csv')
